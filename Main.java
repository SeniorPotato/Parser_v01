...
class Main {
	...
	public static void customCode() {
		...
		if(parser.isInLanguage(cfg, testString)){
			System.out.println("\n\tPASS -- The string CAN be generated by the grammar");
		} else{
			System.out.println("\n\tFAIL -- The string CANNOT be generated by the grammar");
		}

		ParseTreeNode result = parser.generateParseTree(cfg, testString);
		if(result == null) {
